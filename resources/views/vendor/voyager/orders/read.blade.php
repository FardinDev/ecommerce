                    ...
                    <div class="panel-heading" style="border-bottom:0;">
                        ...
                        <table class="table table-hover table-dark">
                                ...
                                @foreach ($products as $product)                      
                                  <tr>
                                    <td>{{ $product->id}}</td>
                                    <td><span class="badge badge-success"><h4>{{ $product->name }}</h4></span></td>
                                    <td><span class="badge badge-success"><h4>{{ $product->pivot->quantity }}</h4></span></td>
                                    <td>${{ $product->presentPrice() * ($product->pivot->quantity) }}</td>
                                  </tr>
