...
@section('page_title', __('Viewing').' '.$dataType->display_name_plural)
    ...
    <div class="container-fluid">
        ...
        @can('add',app($dataType->model_name))
            <a href="{{ route('voyager.'.$dataType->slug.'.create') }}" class="btn btn-success btn-add-new">
                <i class="voyager-plus"></i> <span>{{ __('Add New') }}</span>
            </a>
        @endcan
                                ...
                                <tbody>
                                    ...
                                    <tr class="{{ $data->error ? 'order-error' : '' }} {{ $data->shipped ? 'order-shipped' : '' }}">
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endcan
                                            @can('edit', $data)
                                                <a href="{{ route('voyager.'.$dataType->slug.'.edit', $data->{$data->getKeyName()}) }}" title="{{ __('Edit') }}" class="btn btn-sm btn-primary pull-right edit">
                                                    <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">{{ __('Edit') }}</span>
                                                </a>
                                            @endcan
                                            @can('read', $data)
                                                <a href="{{ route('voyager.'.$dataType->slug.'.show', $data->{$data->getKeyName()}) }}" title="{{ __('View') }}" class="btn btn-sm btn-warning pull-right">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> {{ __('Delete_question') }} {{ strtolower($dataType->display_name_singular) }}?</h4>
                </div>
