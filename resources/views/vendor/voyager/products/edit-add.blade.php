...
@section('page_title', __(''.(isset($dataTypeContent->id) ? 'Edit' : 'Add')).' '.$dataType->display_name_singular)

@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i>
        {{ __(''.(isset($dataTypeContent->id) ? 'Edit' : 'Add')).' '.$dataType->display_name_singular }}
    </h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="confirm_delete">{{ __('Delete_confirm') }}
                    </button>
                </div>
            </div>
        </div>
